    ...
    return (
        <div className="space-y-6" dir="rtl">
            ...
            <div className="bg-white p-12 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-xl font-bold text-gray-800 mb-2">رصد الحضور والغياب</h2>
                <p className="text-gray-500 max-w-md">نظام رصد الحضور الذكي سيكون متاحاً قريباً لكافة المستويات الدراسية.</p>
            </div>
        </div>
    );
}
