...
export default async function CafeteriaPage() {
    ...
    return (
        <div className="space-y-6" dir="rtl">
            <h1 className="text-2xl font-bold text-gray-900">المقصف المدرسي</h1>
            <div className="bg-white p-12 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500 max-w-md">نظام إدارة المقصف والطلبات قيد العمل حالياً وسيتم إطلاقه قريباً.</p>
            </div>
        </div>
    );
}
